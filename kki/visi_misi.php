    ...
    <section class="container-fluid mt-4">
        <div class="row">
            ...
            <div class="card p-4">
                ...
                <h5 class="text-center mb-3"><em>Kota Kediri Unggul Dan Makmur dalam Harmoni</em></h5>
            </div>

            <div class="card p-4">
                <h1 class="text-center mb-4">Misi</h1>
                <h5 class="text-center mb-3"><em>Mewujudkan Tata Kelola Pemerintahan Yang Bersih, Transparan Dan Berintegritas 
                    Berorientasi Pada Pealayanan Prima Dan Teknologi Informasi.</em></h5>
            </div>

                <div class="card p-4">
                    <h2>Visi</h2>
                    <p><em>“Menjadi komunitas pendidikan yang penuh kasih, peduli, cerdas, terampil, dan transformatif, serta berjiwa Pancasila”</em></p>
                    <h4>Penjelasan:</h4>
                    <ol>
                        <li>Penuh Kasih merupakan ajaran untuk mengasihi sesama manusia.</li>
                        <li>Peduli adalah ajaran untuk memberikan rasa simpati dan belas kasihan kepada yang membutuhkan.</li>
                        <li>Cerdas merupakan kondisi yang ingin dicapai dengan pendidikan nasional.</li>
                        <li>Terampil dan transformatif berarti mencapai kompetensi yang dibutuhkan di era modern.</li>
                        <li>Berjiwa Pancasila mencerminkan nilai-nilai luhur bangsa Indonesia.</li>
                    </ol>
            ...
            <section class="col-md-3">
                <h3>Menu Cepat Tentang Kami</h3>
                <div class="list-group contaner;">
                        <a href="#" class="list-group-item">Struktur Organisasi</a>
                        <a href="#" class="list-group-item">Tujuan Sasaran Visi Dan Misi</a>
                        <a href="#" class="list-group-item">Pohon Kinerja</a>
                        <a href="#" class="list-group-item">Tentang Pelayanan</a>
                        <a href="#" class="list-group-item">Tupoksi</a>
                </div>
            </section>
        </div>
    </section>
